document.addEventListener('DOMContentLoaded', function () {
  ...
  const intasela_pwa_install_overlay_menu_js_vars = window['intasela_pwa_install_overlay_menu_js_vars'] || {};
  ...
  if (isPwa() || getCookie('intasela_pwa_menu_overlay_shown')) {
    return;
  }
  ...
  setCookie(`intasela_pwa_menu_overlay_shown`, 'true', intasela_pwa_install_overlay_menu_js_vars.installationPromptsTimeout ?? 1);
});
